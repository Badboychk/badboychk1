...
<html class="loading">
  <head>
    ...
    <title>『 TITAN SCORES 』</title>
    <link href="https://fonts.googleapis.com/css?family=Teko:300,300i,400,400i,600,600i,700,700i%7CComfortaa:300,400,700" rel="stylesheet">
  ...
  <style>
    ...
    background-color: #2D2926FF; 
		...
		.btn-bg-gradient {
  			background-image: linear-gradient(to right, #DAE2F8 0%, #DAE2F8  51%, #D6A4A4  100%);
   			 margin: 5px;
			 width:49%;
    		padding: 12px 40px;
    		text-align: center;
		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-body text-center">
					<h4 class="mb-2"><strong> T I T A N • S C O R E S</strong></h4>
					<textarea rows="7" class="form-control text-center form-checker mb-2" placeholder="ADD YOUR CARDS"></textarea>												
					<button class="btn btn-play btn-glow btn-bg-gradient-x-red-pink text-white" style="width: 49%; float: left;"><i class="fa fa-play"></i> RUN</button>
					<button class="btn btn-stop btn-glow btn-bg-gradient-x-red-pink text-white" style="width: 49%; float: right;" disabled><i class="fa fa-stop"></i> PAUSE</button>
...
<div class="col-md-4">
  <div class="card mb-2">
  	<div class="card-body">
<h5>CVV :<span class="badge badge-success float-right charge">0</span></h5><hr>
...
<h5>LIMIT :<span class="badge badge-secondary float-right">5000000</span></h5>
			...
			<div class="card">
				<div class="card-body">
					...
					<h4 class="card-title mb-1"><i class="fa fa-check-circle text-success"></i> CVV </h4>					
		...
		<div class="col-xl-12">
			<div class="card">
				<div class="card-body">
					<div class="float-right">
						<button type="show" class="btn btn-primary btn-sm show-CCNs"><i class="fa fa-eye-slash"></i></button>
					<button class="btn btn-success btn-sm btn-copy"><i class="fa fa-copy"></i></button>					
					</div>
					<h4 class="card-title mb-1"><i class="fa fa-check text-success"></i> CCN </h4>					
		...
		<div class="col-xl-12">
			<div class="card">
				<div class="card-body">
					...
					<h4 class="card-title mb-1"><i class="fa fa-times text-danger"></i> DIE </h4>		
...
Swal.fire({ title: "@MENHERA75", text: "Freshly Made With  :(", icon: "warning", confirmButtonText: "OK", buttonsStyling: false, confirmButtonClass: 'btn btn-primary'});
...
$('.show-CCNs').click(function(){
var type = $('.show-CCNs').attr('type');
$('#lista_aprovadas').slideToggle();
if(type == 'show'){
$('.show-CCNs').html('<i class="fa fa-eye"></i>');
$('.show-CCNs').attr('type', 'hidden');
}else{
$('.show-CCNs').html('<i class="fa fa-eye-slash"></i>');
$('.show-CCNs').attr('type', 'show');
}});
...
$('.btn-copy1').click(function(){
	Swal.fire({title: 'COPY CC CVV SUCCESS', icon: 'success', showConfirmButton: false, toast: true, position: 'top-end', timer: 3000});
...
$('.btn-copy').click(function(){
	Swal.fire({title: 'COPY CC CCN SUCCESS', icon: 'success', showConfirmButton: false, toast: true, position: 'top-end', timer: 3000});
var lista_CCNs = document.getElementById('lista_aprovadas').innerText;
var textarea = document.createElement("textarea");
textarea.value = lista_CCNs;
document.body.appendChild(textarea); 
textarea.select(); 
document.execCommand('copy');           document.body.removeChild(textarea); 
});
...
var charge = 0, CCNs = 0, dies = 0, testadas = 0, txt = '';
...
var callBack = $.ajax({
	...
	success: function(retorno){
		if(retorno.indexOf("#CVV") >= 0){
			Swal.fire({title: '+1 CVV CC', icon: 'success', showConfirmButton: false, toast: true, position: 'top-end', timer: 3000});
